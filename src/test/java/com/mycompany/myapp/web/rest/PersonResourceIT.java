...
class PersonResourceIT {
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).age(DEFAULT_AGE);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).age(UPDATED_AGE);
        return person;
    }
    ...
    void putExistingPerson() throws Exception {
        ...
        updatedPerson.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).age(UPDATED_AGE);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).age(UPDATED_AGE);
